...
// DateFormatRegex matches the timestamp in a line of the dc_main.log file.
...
// DateFormatRegexShort matches the timestamp in a line of the plc_manager.log file.
